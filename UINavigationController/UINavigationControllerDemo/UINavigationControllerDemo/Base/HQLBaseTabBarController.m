...
- (void)setupViewControllers {
    // 首页
    UIViewController *mainVC = [self renderTabBarItem:[[HQLMainTableViewController alloc] initWithStyle:UITableViewStylePlain]  title:@"首页" normalImage:@"home_normal" selectedImage:@"home_select"];
    HQLBaseNavigationController *mainNav = [[HQLBaseNavigationController alloc] initWithRootViewController:mainVC];
    
    // 我的
    UIViewController *mineVC = [self renderTabBarItem:[[HQLMineTableViewController alloc] initWithStyle:UITableViewStylePlain] title:@"我的" normalImage:@"mine_normal" selectedImage:@"mine_select"];
