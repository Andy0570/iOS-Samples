...
//定义弹出高度
static const CGFloat kPickerViewHeight=300;
...
- (void)showAddressPickView
{
    [UIView animateWithDuration:0.3 animations:^
     {
        self->_wholeView.frame = CGRectMake(0, kAddressPickerScreenHeight-kPickerViewHeight, kAddressPickerScreenWidth, kPickerViewHeight);
...
- (void)hiddenAddressPickView
{
    [UIView animateWithDuration:0.3 animations:^
     {
        self->_wholeView.frame = CGRectMake(0, kAddressPickerScreenHeight, kAddressPickerScreenWidth, kPickerViewHeight);
     } completion:^(BOOL finished) {
         self.currentPickState=NO;
