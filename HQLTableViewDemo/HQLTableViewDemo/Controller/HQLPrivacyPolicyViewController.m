//
//  HQLPrivacyPolicyViewController.m
//  SeaTao
//
...
@interface HQLPrivacyPolicyViewController ()
@property (nonatomic, strong) WKWebViewConfiguration *webViewConfiguration;
@property (nonatomic, strong) WKWebView *webView;
@end

@implementation HQLPrivacyPolicyViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"海店街隐私政策";
...
- (void)renderTemplateData {
    // 1.读取本地 PrivacyPolicy.txt 文件
    NSURL *bundleURL = [[NSBundle mainBundle] bundleURL];
    NSURL *fileURL = [bundleURL URLByAppendingPathComponent:@"PrivacyPolicy.txt"];
