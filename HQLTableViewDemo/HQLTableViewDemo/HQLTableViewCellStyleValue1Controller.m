//
//  HQLTableViewCellStyleValue1Controller.m
//  HQLTableViewDemo
//
...
@interface HQLTableViewCellStyleValue1Controller ()

@end

@implementation HQLTableViewCellStyleValue1Controller

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationItem.title = @"Value1 样式";
