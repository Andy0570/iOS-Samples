...
UIKIT_EXTERN const CGFloat HQLBaseNavigationItemHeight;

/**
 集合视图Cell通用基类，可以在子类中通过覆盖 layoutSubviews 方法重新布局

 视图元素：image View、title Label
 布局方式：上下布局
 布局尺寸：|-10-60-0-17-3-|
*/
@interface HQLBaseNavigationItemCell : UICollectionViewCell
