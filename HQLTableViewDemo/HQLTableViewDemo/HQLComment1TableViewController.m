...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    HQLTopic *currentTopic = (HQLTopic *)[self.topics objectAtIndex:section];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HQLTopic *currentTopic = (HQLTopic *)[self.topics objectAtIndex:indexPath.section];
    HQLComment *currentComment = (HQLComment *)[currentTopic.comments objectAtIndex:indexPath.row];
