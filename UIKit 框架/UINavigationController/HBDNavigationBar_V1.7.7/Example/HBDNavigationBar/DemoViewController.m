...
- (void)viewDidLoad {
    ...
    self.title = [NSString stringWithFormat:@"%lu", (unsigned long)self.navigationController.childViewControllers.count];
    ...
    // 测试打印
    if (@available(iOS 11,*)) {
        NSLog(@"safeAreaInsets.top = %f",self.view.safeAreaInsets.top); // 0
    } else {
