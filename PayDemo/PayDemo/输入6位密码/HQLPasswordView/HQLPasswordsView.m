...
- (UIView *)line {
    if (!_line) {
        _line = [[UIView alloc] initWithFrame:CGRectMake(0, HQLPasswordViewTitleHeight, kScreenWidth, 0.5)];
        _line.backgroundColor = HexColor(@"#CECED2");
    }
    return _line;
}
...
- (UIButton *)forgetPwdButton {
    if (!_forgetPwdButton) {
        ...
        [_forgetPwdButton setTitleColor:rgb(47, 112, 225)
                               forState:UIControlStateNormal];
