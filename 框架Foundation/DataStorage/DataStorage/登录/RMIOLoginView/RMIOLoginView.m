...
- (UIView *)loginContainerView {
    if (!_loginContainerView) {
        _loginContainerView = [[UIView alloc] initWithFrame:CGRectMake(20, 150, UIScreen.jk_width - 40, 215)];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 15, self.loginContainerView.jk_width - 20, 20)];
...
- (UITextField *)usernameTextField {
    if (!_usernameTextField) {
        _usernameTextField = [[UITextField alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(self.titleLabel.frame) + 15, self.loginContainerView.jk_width - 40, 40)];
        // 设置圆角边框
...
- (UIButton *)loginButton {
    if (!_loginButton) {
        ...
        [_loginButton jk_setBackgroundColor:[UIColor colorNamed:@"login_btn_normal"] forState:UIControlStateNormal];
...
- (void)addSubviews {
    ...
    // 蓝色背景视图
    UIView *backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreen.jk_width, 250)];
    ...
    // 猫头鹰脸 116*92
    self.faceRect = CGRectMake(round((UIScreen.jk_width - 116) / 2), 69, 116, 92);
...
- (void)armUpImageAnimation {
    ...
    [UIView animateWithDuration:KOwlAnimationDuration animations:^{
        ...
        CGRect armDownLeftRect = CGRectMake(self->_faceRect.origin.x +29, 148, 0, 0);
        self.armDownLeftImgView.frame = armDownLeftRect;
        CGRect armDownRightRect = CGRectMake(CGRectGetMaxX(self->_faceRect) - 29, 148, 0, 0);
        self.armDownRightImgView.frame = armDownRightRect;
        
        CGRect armUpLeftRect = CGRectMake(self->_faceRect.origin.x - 6, 108, 51, 42);
        self.armUpLeftImgView.frame = armUpLeftRect;
        CGRect armUpRightRect = CGRectMake(self->_faceRect.origin.x + 60, 107, 51, 43);
...
- (void)armDownImageAnimation {
    [UIView animateWithDuration:KOwlAnimationDuration animations:^{
        ...
        CGRect armDownLeftRect = CGRectMake(self->_faceRect.origin.x - 36, 134, 43, 25);
        self.armDownLeftImgView.frame = armDownLeftRect;
        CGRect armDownRightRect = CGRectMake(CGRectGetMaxX(self->_faceRect), 134, 43, 26);
        self.armDownRightImgView.frame = armDownRightRect;
        
        CGRect armUpLeftRect = CGRectMake(self->_faceRect.origin.x - 15, 150, 0, 0);
        self.armUpLeftImgView.frame = armUpLeftRect;
        CGRect armUpRightRect = CGRectMake(CGRectGetMaxX(self->_faceRect) + 15, 150, 0, 0);
        self.armUpRightImgView.frame = armUpRightRect;
    }];
}
