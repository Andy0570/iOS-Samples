...
static NSString *const KForegroundStarImage = @"shockedface2_full";
static NSString *const KBackgroundStarImage = @"shockedface2_empty";
...
@property (nonatomic, copy) XHStarRateViewRateCompletionHandler completionBlock;
...
- (instancetype)initWithFrame:(CGRect)frame
                 numberOfStar:(NSInteger)numberOfStar
                  ...
                  isAnimation:(BOOL)isAnimation
                   completion:(XHStarRateViewRateCompletionHandler)completionBlock
...
- (void)createStarView {
    ...
    NSAssert(_numberOfStar != 0, @"_numberOfStar = 0");
